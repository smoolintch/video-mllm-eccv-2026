...
# 尝试导入 Qwen2.5-VL 或 Qwen2-VL 模型类
try:
    ...
    try:
        ...
        raise ImportError("Neither Qwen2_5_VLForConditionalGeneration nor Qwen2VLForConditionalGeneration found. Please upgrade transformers to >= 4.49.0")
...
try:
    from .qwen2_load_video import process_vision_info_frame_idx
except ImportError:
    # 如果相对导入失败，尝试从 evaluation 目录导入
    import sys
    import os
...
class Qwen2_5_VL(lmms):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if use_flash_attention_2:
            ...
            self._model = MODEL_CLASS.from_pretrained(pretrained, torch_dtype="auto", device_map=self.device_map).eval()
    ...
    def loglikelihood(self, requests: List[Instance]) -> List[Tuple[float, bool]]:
        raise NotImplementedError("Loglikelihood is not implemented for Qwen2_5_VL")
